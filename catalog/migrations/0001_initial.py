    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_type', models.CharField(choices=[('manual', 'User Manual'), ('specification', 'Technical Specification'), ('brochure', 'Product Brochure'), ('other', 'Other Document')], default='other', help_text='Classification of the document', max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('heading', models.CharField(help_text='Specification heading', max_length=255)),
